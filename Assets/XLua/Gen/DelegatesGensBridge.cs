...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public int __Gen_Delegate_Imp4(int p0, out int p1, out bool p2, out string p3, out int p4)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public double __Gen_Delegate_Imp8(double p0, double p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp10(double p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp17(UnityEngine.EventSystems.BaseEventData p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public XLuaTest.InvokeLua.ICalc __Gen_Delegate_Imp20(int p0, string[] p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp21(object p0, object p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp26(object p0, int p1, int p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public int __Gen_Delegate_Imp28(object p0, int p1, int p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public UnityEngine.Vector3 __Gen_Delegate_Imp29(object p0, UnityEngine.Vector3 p1, UnityEngine.Vector3 p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public int __Gen_Delegate_Imp30(object p0, int p1, out double p2, ref string p3)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public int __Gen_Delegate_Imp31(object p0, int p1, out double p2, ref string p3, object p4)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(CustomCall_v1))
			{
			    return new CustomCall_v1(__Gen_Delegate_Imp1);
			}
		
		    if (type == typeof(CustomCall_v2))
			{
			    return new CustomCall_v2(__Gen_Delegate_Imp2);
			}
		
		    if (type == typeof(CustomCall_v_r1))
			{
			    return new CustomCall_v_r1(__Gen_Delegate_Imp3);
			}
		    ...
		    if (type == typeof(CustomCall_v_mr))
			{
			    return new CustomCall_v_mr(__Gen_Delegate_Imp4);
			}
		
		    if (type == typeof(CustomCall_mv))
			{
			    return new CustomCall_mv(__Gen_Delegate_Imp5);
			}
		
		    if (type == typeof(CustomCall_mv_2))
			{
			    return new CustomCall_mv_2(__Gen_Delegate_Imp6);
			}
			...
			{
			    return new System.Func<double, double, double>(__Gen_Delegate_Imp8);
			}
			...
			{
			    return new System.Action<double>(__Gen_Delegate_Imp10);
			}
		    ...
		    if (type == typeof(EventTriggerTools.LuaFuncWithPointerEventDataDelegate))
			{
			    return new EventTriggerTools.LuaFuncWithPointerEventDataDelegate(__Gen_Delegate_Imp17);
			}
			...
			{
			    return new XLuaTest.InvokeLua.CalcNew(__Gen_Delegate_Imp20);
			}
